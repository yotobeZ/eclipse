		...
		<form id="myform"  method="post">
			<table border="1">
				<tr>
					...
					<td><input type="text" id="sname" name="xming" style="font-size: 24" /></td>
				</tr>
				<tr>
					<td style="width: 100px">年龄：</td>
					<td><input type="text" id="sage" name="nling" style="font-size: 24" /></td>
				</tr>
				<tr>
...
$(function () {
	...
	success:function(data){
		...
		$("#llan").append("<tr><td>data.sname</td><td>data.sage</td></tr>");
